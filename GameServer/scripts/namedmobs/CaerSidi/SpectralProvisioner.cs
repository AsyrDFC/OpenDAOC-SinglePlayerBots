	...
	public class SpectralProvisionerBrain : StandardMobBrain
	{
		...
		public override void Think()
		{
			if (Body.IsAlive)
			{
				...
				{
					Body.PathTo(point1, (short)Util.Random(195, 300));
				...
				else
				{
					...
					{
						Body.PathTo(point2, (short)Util.Random(195, 300));
					...
					else
					{
						...
						if (!Body.IsWithinRadius(point3, 30) && point1check == true && point2check == true &&
							point3check == false)
						{
							Body.PathTo(point3, (short)Util.Random(195, 300));
						...
						else
						{
							...
							{
								Body.PathTo(point4, (short)Util.Random(195, 300));
							...
							else
							{
								...
								{
									Body.PathTo(point5, (short)Util.Random(195, 300));
								...
								else
								{
									...
									{
										Body.PathTo(point6, (short)Util.Random(195, 300));
									...
									else
									{
										...
										{
											Body.PathTo(point7, (short)Util.Random(195, 300));
										...
										else
										{
											...
											{
												Body.PathTo(point8, (short)Util.Random(195, 300));
