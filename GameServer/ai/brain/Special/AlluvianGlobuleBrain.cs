	...
	public class AlluvianGlobuleBrain : StandardMobBrain
	{
		...
		public override void Think()
		{
			...
			if (!Body.attackComponent.AttackState && !Body.IsMoving && !Body.InCombat)
			{
				...
				Body.PathTo(new Point3D(544196 + Util.Random(1, 3919), 514980 + Util.Random(1, 3200), 3140 + Util.Random(1, 540)), 80);
			}
		}
		...
		public void WalkFromSpawn()
		{
			...
			Body.PathTo(new Point3D((int) targetX, (int) targetY, 3083), 150);
		}
